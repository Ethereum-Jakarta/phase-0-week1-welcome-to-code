...
let tanggal = 7; // assign nilai variabel tanggal disini! (dengan angka antara 1 - 31)
let bulan = 3; // assign nilai variabel bulan disini! (dengan angka antara 1 - 12)
let tahun = 1999; // assign nilai variabel tahun disini! (dengan angka antara 1900 - 2200)
